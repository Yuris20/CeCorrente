    ...
    <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
      <div class="content content-full">
        ...
        <div class="px-30 py-10">
          ...
          <h2 class="h5 font-w400 text-muted mb-0">Perfavore iniserisci le credenziali</h2>
        </div>
        <!-- END Header -->

        <form class="js-validation-signin px-30" action="<?php echo $cb->assets_folder; ?>/php/controlloDip.php" method="post">
