...
require 'assets/php/ConnessioneDb.php';
...
$CocC=$_GET['CC'];
/*
$sql = "SELECT cliente.CodCliente,cliente.IndirizzoFiscale,comuni.CAP,comuni.Comune,comuni.Provincia,cliente.Nome,cliente.Cognome,RagioneSociale FROM cliente INNER JOIN comuni ON CodCliente= '$CocC' GROUP BY CodCliente;";
*/
...
$sql = "select KWh from lettura left join contatore on lettura.CodCont=contatore.CodCont left join contratto on contatore.codc=contratto.codc where contratto.codcliente='$CocC' ORDER BY DataLettura DESC"; // recupero l'ultima lettura per fare il calcolo
